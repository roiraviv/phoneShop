...
function ProductForm({ form, setForm, isPhone }) {
...
export default function InventoryPage() {
  ...
  const openAdd = (type) => {
    setEditing(null);
    setForm(type === 'phone' ? { ...EMPTY_PHONE } : { ...EMPTY_ACCESSORY });
    setError('');
    setModalOpen(true);
  };
  ...
  return (
    <div className="page-shell">
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="font-body-sm text-body-sm">
                  {loading ? (
                    ...
                    <tr><td colSpan={7} className="p-8 text-center text-secondary">No products found</td></tr>
                  ) : (
                    products.map((p, i) => (
                      <tr
                        key={p.id}
      ...
      >
        ...
        <ProductForm form={form} setForm={setForm} isPhone={form.productType === 'phone'} />
